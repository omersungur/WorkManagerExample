...
class RefreshDatabase(val context: Context, workerParams: WorkerParameters) : Worker(context,
    ...
    override fun doWork(): Result {
        val getData = inputData // diğer taraftan yolladığımız veriyi alabilmek için oluşturduk.
    ...
    private fun refreshDatabase(myNumber : Int) {
        val sharedPreferences = context.getSharedPreferences("com.omersungur.workmanagerexample",Context.MODE_PRIVATE)
